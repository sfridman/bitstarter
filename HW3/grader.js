...
// var URL_DEFAULT = "http://blooming-lowlands-7383.herokuapp.com";
...
var checkHtmlFile = function(isHtml, htmlfile, checksfile) {
    $ = isHtml ? cheerioHtmlFile(htmlfile) : cheerio.load(htmlfile);
